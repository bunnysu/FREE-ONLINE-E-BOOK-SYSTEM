                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Lists of  Feedback  </h4>
...
<?php
$query=mysqli_query($con,"SELECT student.FullName as name,feedback.rating as rate,feedback.comment as ment,feedback.date as time
FROM feedback
INNER JOIN student
...
<td><?php echo htmlentities($row['ment'])?></td>
