            ...
            <div class="main">
                <div class="file-sight">
                    <svg version="1.1" id="file-sight-svg" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path id="file-sight-movepath" fill="none" stroke="#ECECEC" stroke-width="2"
                            stroke-miterlimit="10" d="M6,18.154c12.285,0.178,29.812,8.875,29.812,8.875
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li>
                        <button class="button-menu-mobile open-left waves-effect">
                            <i class="mdi mdi-menu humburger"></i>
                        </button>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown user-box">
                        <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown"
                            aria-expanded="true">
                            <img src="assets/images/book.png" alt="user-img" class="img-circle user-img">
                        </a>
                        ...
                        <ul
                            ...
                            <li><a href="change-password.php"><i class="ti-settings m-r-5 i"></i> Change Password</a></li>

                            <li><a href="logout.php"><i class="ti-power-off m-r-5 i"></i> Logout</a></li>
                        </ul>
                    </li>
