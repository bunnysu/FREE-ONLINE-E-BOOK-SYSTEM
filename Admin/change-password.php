                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="dashboard.php" class="admin">Admin</a>
                                        </li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title admin"><b>Change Password </b></h4>
                                    <hr />
                                    ...
                                    <div class="col-md-10">
                                        <form class="form-horizontal" name="chngpwd" method="post"
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label admin">Current Password</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label admin">New Password</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label admin">Confirm Password</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <button type="submit" class="btn custom-btn" name="submit">
                                                        Submit
                                                    </button>
                                                </div>
                                            </div>
